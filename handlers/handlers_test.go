	...
	tt := []struct {
		...
		},
		{
			...
			mockFunc: func() {
				...
				s.mockSql.ExpectExec(regexp.QuoteMeta("INSERT INTO urls(id, short_url, long_url, expire_at) VALUES ($1, $2, $3, $4)")).WithArgs(66666, "HLG", "https://amazon.com", "2030-02-20T09:20:41+08:00").WillReturnResult(sqlmock.NewResult(1, 1))
			},
			reqBody: `{"url": "https://amazon.com", "expireAt": "2030-02-20T09:20:41+08:00"}`,
		},
	}
